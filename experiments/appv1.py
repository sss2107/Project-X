...
st.set_page_config(page_title="Joey", page_icon="😇")
html_temp = """
<div style="background-color:brown;padding:10px">
<h2 style="color:white;text-align:center;">Joey </h2>
</div>
"""
st.markdown(html_temp,unsafe_allow_html=True)
st.sidebar.header("Joey")

st.write("""When writing prompt, be as detailed as possible. You can check the examples on the left for reference.""")

# st.write("""Please input your aircraft defect logs here, if your prompt is quite long, can use the handle on bottom right to adjust the input box height.""")
